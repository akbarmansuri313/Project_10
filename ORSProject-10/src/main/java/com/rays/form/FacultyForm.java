...
/**
 * Form class for capturing Faculty details. Provides validation and DTO
 * conversion.
 */
public class FacultyForm extends BaseForm {
	...
	@Min(value = 1, message = "College selection is required")
	private Long collegeId = 0L;

	private String collegeName;

	@NotNull(message = "Course is required")
	@Min(value = 1, message = "Course selection is required")
	private Long courseId = 0L;

	private String courseName;

	@NotNull(message = "Subject is required")
	@Min(value = 1, message = "Subject selection is required")
