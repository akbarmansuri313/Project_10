...
/**
 * SubjectCtl is a REST controller for managing subject-related operations.
 * 
 * It provides endpoints to preload course dropdown lists for subject management.
 * 
...
public class SubjectCtl extends BaseCtl<SubjectForm, SubjectDTO, SubjectServiceInt> {
	...
	/**
	 * Preload courses for subject management dropdowns.
	 * 
